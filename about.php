...
$result = mysqli_query($conn, $query);
    ...
    <main>
        <section>
            ...
            <p>We are a team of Software Developers on Sustainable Energy Solutions at Green Grid dedicated to creating websites for <span class="red_highlight">sustainable solutions, development and employment of renewable energy technologies.</span></p>
		</section>
         <section>
